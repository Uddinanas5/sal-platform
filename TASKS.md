...
- [ ] **P1-9 · Legal/support emails point to an unregistered domain.** `src/app/terms/page.tsx:229`, `src/app/privacy/page.tsx:179,240`, `src/components/dashboard/header.tsx:153` all use `hello@salplatform.com` (no MX). Every support/legal contact bounces.
