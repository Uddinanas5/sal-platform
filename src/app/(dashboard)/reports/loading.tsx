  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        {/* Tab bar */}
        <div className="flex items-center gap-1 bg-white/[0.04] border border-cream-200 rounded-xl p-1.5 w-fit">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="glass-panel rounded-panel p-5 space-y-4">
