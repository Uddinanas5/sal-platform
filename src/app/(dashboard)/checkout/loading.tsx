    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="p-6">
        <div className="flex gap-6">
          ...
          <div className="w-[60%] space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {Array.from({ length: 9 }).map((_, i) => (
                <div
                  key={i}
                  className="bg-card/80 border border-cream-200 rounded-xl p-4 space-y-3"
                >
          ...
          {/* Right: Cart panel (40%) */}
          <div className="w-[40%]">
            <div className="bg-card/80 border border-cream-200 rounded-xl p-5 space-y-4 sticky top-6">
