...
const TIMEZONES = [
  ...
  { value: "America/Halifax", label: "Canada - Atlantic (AT)" },
  { value: "America/St_Johns", label: "Canada - Newfoundland (NT)" },
  ...
  { value: "Europe/Zurich", label: "Switzerland (CET)" },
  { value: "Europe/Vienna", label: "Austria (CET)" },
  { value: "Europe/Stockholm", label: "Sweden (CET)" },
  { value: "Europe/Oslo", label: "Norway (CET)" },
  { value: "Europe/Copenhagen", label: "Denmark (CET)" },
  { value: "Europe/Helsinki", label: "Finland (EET)" },
  { value: "Europe/Warsaw", label: "Poland (CET)" },
  { value: "Europe/Lisbon", label: "Portugal (WET)" },
  { value: "Europe/Athens", label: "Greece (EET)" },
  { value: "Europe/Bucharest", label: "Romania (EET)" },
  ...
  { value: "Asia/Beirut", label: "Lebanon (EET)" },
